...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.5ctwbw8.mongodb.net/?retryWrites=true&w=majority`;
...
app.listen(port, () => console.log(`Doctor Portal is Runing on Port: ${port}`));
